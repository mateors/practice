...
func main() {
	...
	// ret, _ := crypt.Generate([]byte("secret"), []byte("$6$salt"))
	// fmt.Println(ret)
	...
	// err := crypt.Verify(hashpass, []byte("test123"))
	// fmt.Println(err)

	// entr, err := Lookup("mostain")
	// if err != nil {
	// 	fmt.Println(err)
	// 	return
	// }

	// //fmt.Println("pass:", entr.Pass)
	// err = entr.VerifyPassword("test123")
	// fmt.Println(err)
